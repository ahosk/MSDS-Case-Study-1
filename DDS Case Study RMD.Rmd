...
#reading in data
beers = read_csv('Desktop/Beers.csv')
breweries = read_csv('Desktop/Breweries.csv')
...
states_map
state_heat = left_join(state,brew_cnt)
...
states_map %>%
   ...
   theme(axis.text= element_blank(),
         ...
         legend.title = 'Breweries in State')
